...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa8\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\r.user.v1.UserR\x04user2\xff\x01\n" +
	"\vUserService\x12<\n" +
	...
	"\bRegister\x12\x18.user.v1.RegisterRequest\x1a\x19.user.v1.RegisterResponseBJZHgithub.com/tuannguyenandpadcojp/fresher26/nam/users/proto/user/v1;userv1b\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*RegisterResponse)(nil),      // 8: user.v1.RegisterResponse
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 4: user.v1.RegisterResponse.user:type_name -> user.v1.User
	...
	7, // 8: user.v1.UserService.Register:input_type -> user.v1.RegisterRequest
	...
	6, // 11: user.v1.UserService.Logout:output_type -> user.v1.LogoutResponse
	8, // 12: user.v1.UserService.Register:output_type -> user.v1.RegisterResponse
